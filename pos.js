...
if (auth == undefined) {
    ...
    if (platform != undefined) {
        ...
        if (platform.app == 'Punto de Venta en Red') {
    ...
    $(document).ready(function () {
        ...
        function loadCustomers() {
            ...
            $.get(api + 'customers/all', function (customers) {
                ...
                $('#customer').html(`<option value="0" selected="selected">Caminar en el cliente</option>`);
        ...
        <left>
            ...
            Customer : ${customer == 0 ? 'Caminar en el cliente' : customer.name} <br>
                        ...
                        $('<a>').append(
                            $('<div>', { class: 'card-box order-box' }).append(
                                $('<p>').append(
                                    ...
                                    $('<br>'),
                                    $('<b>', { text: 'Customer :' }),
                                    $('<span>', { text: order.customer != 0 ? order.customer.name : 'Caminar en el cliente', class: 'customer_name' })
                                ),
        ...
        $.fn.orderDetails = function (index, orderType) {
            ...
            if (orderType == 1) {
                ...
                $("#customer option").filter(function () {
                    return $(this).text() == "Caminar en el cliente";
                }).prop("selected", true);
        ...
        $.fn.deleteOrder = function (index, type) {
            ...
            Swal.fire({
                ...
                text: "Esto eliminará el pedido. ¿Está seguro de que desea eliminarlo?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
        ...
        $.fn.deleteTransaction = function (index, type) {
            ...
            Swal.fire({
                title: "Eliminar ?",
                text: "Esto eliminará la transaccion. ¿Está seguro de que desea eliminarla?",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: "¡Sí, bórrarla!"
            }).then((result) => {
        ...
        $('#app').change(function () {
            if ($(this).find('option:selected').text() == 'Punto de Venta en Red') {
        ...
        if (transactions.length > 0) {
            ...
            transactions.forEach((trans, index) => {
                ...
                transaction_list += `<tr>
								...
								<td><span class="btn"><button onClick="$(this).deleteTransaction( )" class="btn btn-danger"><i class="fa fa-trash"></i></button></span></td>'}</tr>
								`;
...
$.fn.viewTransaction = function (index) {
    ...
    let customer = allTransactions[index].customer == 0 ? 'Caminar en el cliente' : allTransactions[index].customer.username;
    ...
    <left>
        ...
        Ref No : ${refNumber} <br>
        Customer : ${allTransactions[index].customer == 0 ? 'Caminar en el cliente' : allTransactions[index].customer.name} <br>
